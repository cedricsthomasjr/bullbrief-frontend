                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            },
                            {
                                ...
                                value: `${(data.dividend_yield ?? 0 * 100).toFixed(2)}%`
                            },
                            {
                                label: "Beta",
                                value: data.beta
                            ...
                            {
                                label: "Avg Volume",
                                value: data.avg_volume?.toLocaleString()
                            },
                            {
                            ...
                            },
                            {
                                ...
                                value: `$${(data.free_cashflow / 1e6).toFixed(2)}M`
                            },
                            {
                            ...
                            {
                                label: "Profit Margin",
                                value: `${(data.profit_margin ?? 0 * 100).toFixed(2)}%`
                            },
                            {
                                label: "Institutional Ownership",
                                value: `${(data.institutional_ownership ?? 0 * 100).toFixed(2)}%`
                            },
                            {
                                label: "Short % of Float",
                                value: `${(data.short_percent ?? 0 * 100).toFixed(2)}%`
                            }
...
//# sourceMappingURL=app_cef05f60._.js.map