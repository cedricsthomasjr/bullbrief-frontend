...
function TickerCompareInput() {
    ...
    const handleSubmit = (e)=>{
        e.preventDefault();
        const tickers = input.toUpperCase().replace(/[^A-Z0-9,\s]/g, "") // Strip invalid characters
        .split(/[\s,]+/) // Split by space or comma
        .filter(Boolean); // Remove empty strings
        if (tickers.length < 2 || tickers.length > 3) {
            alert("Enter 2–3 valid tickers (e.g., AAPL, MSFT, GOOGL)");
            return;
        }
...
//# sourceMappingURL=_236eaf87._.js.map