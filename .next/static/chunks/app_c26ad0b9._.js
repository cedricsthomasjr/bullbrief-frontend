...
function MetricDetailPage() {
                ...
                "MetricDetailPage.useEffect.fetchData": async ()=>{
                    ...
                    try {
                        ...
                        if ([
                            ...
                            const key = Object.keys(json.data).find({
                                "MetricDetailPage.useEffect.fetchData.key": (k)=>k.toLowerCase() === metric.toLowerCase()
                            }["MetricDetailPage.useEffect.fetchData.key"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MetricDetailPage.useEffect": ()=>{
            if (!ticker || !metric) return;
            const fetchAI = {
                "MetricDetailPage.useEffect.fetchAI": async ()=>{
            ...
            }["MetricDetailPage.useEffect.fetchAI"];
            fetchAI();
        }
    }["MetricDetailPage.useEffect"], [
        ticker,
